...
public class FrmQuanLyPhim extends JFrame {
    ...
    private JPanel tabPhim, tabDaoDien, tabTheLoai;
    ...
    private void setupUI() {
        setTitle("Quản Lý Phim, Đạo Diễn & Thể Loại");
        ...
        tabPhim = createPhimTab();
        tabDaoDien = createDaoDienTab();
        tabTheLoai = createTheLoaiTab();
    ...
    private JPanel createHeader() {
        ...
        pnlHeader.setBackground(ColorPalette.PRIMARY);
        pnlHeader.setPreferredSize(new Dimension(1200, 70));
        pnlHeader.setLayout(new BorderLayout());
        pnlHeader.setBorder(new EmptyBorder(15, 20, 15, 20));

        JLabel lblTitle = new JLabel("Hệ Thống Quản Lý Phim, Đạo Diễn & Thể Loại");
    ...
    private void handleThemDaoDien() {
        try {
            JDialog dialog = new JDialog(this, "Thêm Đạo Diễn", true);
    ...
    private void handleSuaDaoDien() {
        ...
        try {
            ...
            JDialog dialog = new JDialog(this, "Sửa Đạo Diễn", true);
            dialog.setSize(500, 350);
            dialog.setLocationRelativeTo(this);
    ...
    private void handleThemTheLoai() {
        try {
            JDialog dialog = new JDialog(this, "Thêm Thể Loại", true);
    ...
    private void handleSuaTheLoai() {
        ...
        try {
            ...
            JDialog dialog = new JDialog(this, "Sửa Thể Loại", true);
            dialog.setSize(450, 250);
            dialog.setLocationRelativeTo(this);
